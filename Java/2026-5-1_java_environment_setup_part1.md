...
> - Package name: Javaのパッケージ名（通常はGroupとArtifactを組み合わせた名前）<br>
...
Dependenciesとは「アプリケーションが動作するために必要な外部ライブラリ」のこと

これらの内容をpom.xmlに依存関係の中に追加することで、Webアプリケーションの基本機能やテンプレートエンジン（Thymeleaf）を簡単に利用できるようになる
